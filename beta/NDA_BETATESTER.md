...
- **«Log Anonimizzati»**: Log dai quali sono stati rimossi automaticamente dal Software tutti i dati sensibili identificati all'Art. 11.3 prima dell'esportazione.
...
- **«Provider AI»**: servizi di intelligenza artificiale di terze parti (es. OpenAI, Anthropic/Claude, Google Gemini) utilizzati dal Software per l'elaborazione del testo tramite le API Key del Betatester.
...
- **«Tier 1 — Contributor»**: categoria di Betatester che elabora un Dataset di Input
  ...
  Può ricevere rimborso forfettario di €5 alle condizioni dell'Art. 7.
...
Betatester, ad eccezione di quanto previsto dall'Art. 7 per i Betatester
...
### Articolo 7 — Rimborso Forfettario ai Betatester

**7.1 Rimborso Tier 1 — Contributor.** Il Betatester classificato Tier 1
...
**7.2 Rimborso Tier 2 — Certificatore.** Il Betatester classificato Tier 2
...
**7.3 Condizioni generali del rimborso.**

a) Il Titolare può rifiutare il rimborso **esclusivamente** se il feedback risulta
   manifestamente incompleto (mancanza di una o più sezioni obbligatorie del
   FEEDBACK_TEMPLATE.md) o se i log inviati sono corrotti, inutilizzabili o
   manomessi.
...
h) La richiesta di rimborso deve essere presentata dal Betatester entro **60
   (sessanta) giorni** dalla scadenza della Licenza, pena la decadenza del
   diritto al rimborso.

**7.4 Benefit non monetari.** Indipendentemente dal rimborso, i Betatester
...
| Aggiornamenti automatici inclusi | No | No |
| Supporto | Limitato a bug critici | Limitato a bug critici |

La «licenza gratuita di 6 mesi» concessa ai Contributor Tier 1 è una licenza
personale, non trasferibile, che consente l'utilizzo del Software nella versione
disponibile al momento del rilascio commerciale per un periodo di 6 (sei) mesi.
Non include il diritto a ricevere aggiornamenti futuri, nuove funzionalità o
versioni successive del Software. Il supporto è limitato alla segnalazione e alla
correzione di bug critici che rendano il Software inutilizzabile; non include
supporto per configurazione, ottimizzazione, nuove funzionalità o problemi non
riproducibili.
...
**8.1** Il Betatester si impegna a mantenere strettamente riservate tutte le Informazioni Riservate e a non divulgarle, trasmetterle o renderle accessibili a terzi, in qualsiasi forma, senza il preventivo consenso scritto del Titolare.

**8.2** L'obbligo di riservatezza comprende, in via esemplificativa e non esaustiva:
...
**8.3 Eccezioni.** L'obbligo di riservatezza non si applica alle informazioni che:
...
**8.4 Durata.** L'obbligo di riservatezza rimane in vigore per **5 (cinque) anni** dalla scadenza o dalla risoluzione anticipata del presente Accordo.

---

### Articolo 9 — Divulgazione Responsabile delle Vulnerabilità

**9.1** Nel caso in cui il Betatester scopra o ragionevolmente sospetti l'esistenza di una vulnerabilità di sicurezza nel Software, è tenuto a:
...
c) mantenere riservata la vulnerabilità per tutta la durata della Licenza e per i **90 (novanta) giorni** successivi alla sua scadenza.

**9.2** Il Betatester è libero di divulgare la vulnerabilità pubblicamente **solo dopo 90 (novanta) giorni dalla scadenza della Licenza**, previa ulteriore comunicazione scritta al Titolare. Questa disposizione si applica indipendentemente dallo stato del fix da parte del Titolare.

**9.3** Il Betatester non può in alcun caso sfruttare le vulnerabilità scoperte per finalità proprie o per conto di terzi.

---

### Articolo 10 — Proprietà Intellettuale e Feedback

**10.1 Proprietà del Software.** PurifyFactory v9.1.6, inclusi il Binario, il codice sorgente, la documentazione, il sistema di licensing, gli algoritmi, i modelli di dati e tutti i componenti, sono e rimarranno di **esclusiva proprietà del Titolare**. Il presente Accordo non trasferisce al Betatester alcun diritto di proprietà intellettuale sul Software, né su qualsiasi suo componente.

**10.2 Proprietà del Feedback.** Qualsiasi Feedback fornito dal Betatester al Titolare durante o dopo il programma beta diventa automaticamente e irrevocabilmente **proprietà esclusiva del Titolare**, senza obbligo di compenso, riconoscimento o notifica al Betatester. Il Betatester concede al Titolare una licenza perpetua, irrevocabile, mondiale, gratuita e sublicenziabile per qualsiasi utilizzo del Feedback, e rinuncia a qualsiasi rivendicazione di rimborsi o compensi di qualsiasi natura relativi al Feedback fornito.

**10.3** Il Titolare è libero di incorporare, modificare, distribuire, commercializzare o non utilizzare il Feedback a propria esclusiva discrezione.
...
**11.2 Dati raccolti.** Il Titolare tratta esclusivamente i dati volontariamente trasmessi dal Betatester nell'ambito del programma beta:

- dati identificativi forniti in fase di sottoscrizione del presente Accordo (nome, cognome, email);
- Log Anonimizzati esportati tramite il comando `export-debug`, come descritti all'Art. 11.3;
- Dataset di Input e/o Output, esclusivamente se il Betatester sceglie di condividerli ai sensi dell'Art. 13.

**11.3 Anonimizzazione automatica dei Log.** Il comando `export-debug` rimuove automaticamente dalle righe di log le seguenti categorie di dati prima di qualsiasi esportazione:
...
**11.4 Finalità e base giuridica.** Il trattamento è effettuato per le seguenti finalità:
...
| Log Anonimizzati (senza dati personali residui) | Tempo indeterminato, per finalità di sviluppo — non soggetti ai limiti di conservazione GDPR in quanto privi di dati personali |
...
**11.6 Diritti dell'interessato.** Il Betatester ha diritto di accesso, rettifica, cancellazione («diritto all'oblio»), limitazione del trattamento, portabilità dei dati e opposizione al trattamento, da esercitare scrivendo a betatesting@purifyfactory.com. Ha inoltre il diritto di proporre reclamo all'Autorità Garante per la protezione dei dati personali (www.garanteprivacy.it).
...
### Articolo 12 — Canali di Comunicazione Ufficiali

**12.1** I canali ufficiali di comunicazione tra il Betatester e il Titolare sono i seguenti:
...
**12.2** Per tutte le comunicazioni, il Betatester deve indicare nell'oggetto dell'email: «Beta v9.1.6 — [Cognome del Betatester]».

**12.3** Il Betatester è responsabile di mantenere aggiornato il proprio indirizzo email e di verificare regolarmente la propria casella di posta. Comunicazioni inviate all'indirizzo email indicato in firma si intendono ricevute.

**12.4 Avviso di sicurezza.** Il Titolare non richiederà mai al Betatester API Key, password, credenziali di accesso o file di licenza tramite email o qualsiasi altro canale non concordato. Qualsiasi richiesta in tal senso deve essere considerata fraudolenta e segnalata immediatamente.

---

### Articolo 13 — Condivisione Volontaria dei Dati per la Certificazione

**13.1** Per le finalità di certificazione TRL5 e di miglioramento del Software, al Betatester è richiesto di condividere i seguenti materiali:
...
**13.2** La condivisione dei Dataset di Input e/o Output è **completamente facoltativa**. Il Betatester può scegliere di non condividerli senza alcuna conseguenza sulla validità del presente Accordo o sull'accesso al Software.

**13.3** Il Betatester che sceglie di condividere i Dataset è consapevole che questi potrebbero contenere dati personali o riservati e ne autorizza il trattamento ai sensi dell'Art. 11, con conservazione massima di 12 mesi.

**13.4** Il Betatester è l'unico responsabile di verificare che i Dataset condivisi non contengano dati personali di terzi per cui non dispone delle necessarie autorizzazioni al trattamento.

**13.5 Requisiti minimi del Dataset per la certificazione TRL5.** Al fine di produrre dati utilizzabili ai fini della certificazione TRL5, il Dataset elaborato durante il programma beta deve rispettare le seguenti soglie minime:
...
**14.1** Il Software è fornito nella sua configurazione di versione beta, «così come è» («as is»), **senza alcuna garanzia, espressa o implicita**.

**14.2** Il Titolare esclude espressamente qualsiasi garanzia relativa a:
...
**14.3** Il Betatester riconosce esplicitamente di star utilizzando software in fase di sviluppo e testing, non destinato a uso produttivo, e accetta consapevolmente tutti i rischi connessi.

---

### Articolo 15 — Limitazione di Responsabilità

**15.1 Il Titolare non è responsabile, in nessuna misura e a nessun titolo, per qualsiasi danno diretto, indiretto, incidentale, speciale, consequenziale o punitivo** derivante dall'utilizzo, dall'impossibilità di utilizzo o dai risultati del Software, inclusi, in via esemplificativa: perdita di dati, perdita di profitti, interruzione dell'attività, danni al sistema hardware o software, costi API non previsti, fatto salvo il caso di dolo o colpa grave del Titolare.
...
**16.1** Il presente Accordo entra in vigore alla data di sottoscrizione di entrambe le parti e rimane valido fino alla scadenza della Licenza (90 giorni), salvo risoluzione anticipata.

**16.2 Risoluzione da parte del Titolare.** Il Titolare può risolvere anticipatamente il presente Accordo con effetto immediato, mediante comunicazione scritta, in caso di:
...
**16.3 Recesso del Betatester.** Il Betatester può recedere dal presente Accordo in qualsiasi momento inviando comunicazione scritta al Titolare.

**16.4 Obblighi post-scadenza.** Alla scadenza o risoluzione del presente Accordo, il Betatester è tenuto a:
...
**16.5 Sopravvivenza.** Le disposizioni relative a riservatezza (Art. 8), proprietà intellettuale (Art. 10), trattamento dei dati (Art. 11) e limitazione di responsabilità (Art. 15) sopravvivono alla scadenza o alla risoluzione del presente Accordo.
...
**17.2** Per qualsiasi controversia relativa all'interpretazione, all'esecuzione o alla risoluzione del presente Accordo, le parti eleggono come **foro competente esclusivo il Tribunale Ordinario di Velletri**.

**17.3** Prima di adire l'autorità giudiziaria, le parti si impegnano a tentare una risoluzione amichevole della controversia. La parte che intende avviare una procedura giudiziale è tenuta a notificare previamente per iscritto il proprio disaccordo, concedendo all'altra parte un termine di **30 (trenta) giorni** per raggiungere una soluzione concordata.

---

### Articolo 18 — Disposizioni Generali

**18.1 Integralità dell'Accordo.** Il presente Accordo costituisce l'intero accordo tra le parti in relazione all'oggetto del medesimo e sostituisce integralmente qualsiasi accordo, intesa o comunicazione precedente, scritta o verbale.

**18.2 Modifiche.** Qualsiasi modifica al presente Accordo deve essere effettuata per iscritto e firmata da entrambe le parti. Modifiche unilaterali non producono effetti.

**18.3 Nullità parziale.** L'eventuale nullità, inefficacia o inapplicabilità di una singola disposizione non pregiudica la validità delle restanti disposizioni, che rimarranno pienamente efficaci.

**18.4 Rinuncia.** La mancata o tardiva esecuzione di qualsiasi disposizione del presente Accordo da parte del Titolare non costituisce rinuncia al diritto di farla valere in futuro.

**18.5 Cessione.** Il Betatester non può cedere, trasferire o delegare i propri diritti o obblighi derivanti dal presente Accordo senza il preventivo consenso scritto del Titolare.

**18.6 Comunicazioni.** Tutte le comunicazioni formali previste dal presente Accordo devono essere effettuate per iscritto tramite **PEC all'indirizzo a.lattanzi.pec@postecert.it** oppure tramite raccomandata A/R. Le comunicazioni via email ordinaria non hanno valore legale ai fini del presente Accordo.
...
- **«Anonymized Logs»**: Logs from which all sensitive data (as identified in Art. 11.3) has been automatically removed by the Software prior to export.
...
- **«Tier 1 — Contributor»**: category of Beta Tester who processes an Input Dataset
  ...
  May receive a €5 flat reimbursement under the conditions of Art. 7.
...
Beta Tester, except as provided in Art. 7 for Beta Testers who complete
...
### Article 7 — Flat Reimbursement for Beta Testers

**7.1 Tier 1 — Contributor reimbursement.** A Beta Tester classified as Tier 1
...
**7.2 Tier 2 — Certifier reimbursement.** A Beta Tester classified as Tier 2
...
**7.3 General reimbursement conditions.**

a) The Owner may refuse reimbursement **exclusively** if the feedback is manifestly incomplete (missing one or more mandatory sections of FEEDBACK_TEMPLATE.md) or if the submitted logs are corrupted, unusable, or tampered with.
...
h) The request for reimbursement must be submitted by the Beta Tester within **60
   (sixty) days** of License expiration, failing which the right to reimbursement
   shall be forfeited.

**7.4 Non-monetary benefits.** Regardless of reimbursement, Beta Testers
...
| Automatic updates included | No | No |
| Support | Limited to critical bugs | Limited to critical bugs |

The «6-month free license» granted to Tier 1 Contributors is a personal,
non-transferable license that allows use of the Software in the version available
at the time of commercial release for a period of 6 (six) months. It does not
include the right to receive future updates, new features, or subsequent versions
of the Software. Support is limited to reporting and fixing critical bugs that
render the Software unusable; it does not include support for configuration,
optimization, new features, or non-reproducible issues.
...
**8.1** The Beta Tester undertakes to keep strictly confidential all Confidential Information and not to disclose, transmit, or make accessible to any third party, in any form, without the Owner's prior written consent.

**8.2** The confidentiality obligation includes, by way of non-exhaustive example:
...
**8.3 Exceptions.** The confidentiality obligation does not apply to information that:
...
**8.4 Duration.** The confidentiality obligation remains in force for **5 (five) years** following the expiration or early termination of this Agreement.

---

### Article 9 — Responsible Disclosure of Security Vulnerabilities

**9.1** Should the Beta Tester discover or reasonably suspect the existence of a security vulnerability in the Software, they are required to:
...
c) keep the vulnerability confidential for the entire duration of the License and for **90 (ninety) days** following its expiration.

**9.2** The Beta Tester is free to publicly disclose the vulnerability **only after 90 (ninety) days from License expiration**, subject to prior further written notification to the Owner. This provision applies regardless of the status of any fix by the Owner.

**9.3** The Beta Tester shall not exploit discovered vulnerabilities for personal gain or for the benefit of any third party.

---

### Article 10 — Intellectual Property and Feedback

**10.1 Software ownership.** PurifyFactory v9.1.6, including the Binary, source code, documentation, licensing system, algorithms, data models, and all components, is and shall remain the **exclusive property of the Owner**. This Agreement does not transfer to the Beta Tester any intellectual property rights in the Software or any of its components.

**10.2 Feedback ownership.** Any Feedback provided by the Beta Tester to the Owner during or after the beta program automatically and irrevocably becomes the **exclusive property of the Owner**, without any obligation of compensation, credit, or notification to the Beta Tester. The Beta Tester grants the Owner a perpetual, irrevocable, worldwide, royalty-free, sublicensable license for any use of the Feedback, and waives any claim to reimbursements or compensation of any nature in connection with Feedback provided.

**10.3** The Owner is free to incorporate, modify, distribute, commercialize, or not use the Feedback at its sole discretion.
...
**11.2 Data collected.** The Owner processes only data voluntarily transmitted by the Beta Tester in connection with the beta program:

- identification data provided upon signing (name, surname, email address);
- Anonymized Logs exported via the `export-debug` command, as described in Art. 11.3;
- Input and/or Output Datasets, exclusively if the Beta Tester elects to share them pursuant to Art. 13.

**11.3 Automatic log anonymization.** The `export-debug` command automatically removes the following categories of data from log lines prior to any export:
...
**11.4 Purposes and legal basis.** Processing is carried out for the following purposes:
...
| Anonymized Logs (no residual personal data) | Indefinite, for development purposes — not subject to GDPR retention limits as they contain no personal data |
...
### Article 12 — Official Communication Channels

**12.1** The official communication channels between the Beta Tester and the Owner are as follows:
...
**12.2** For all communications, the Beta Tester must include in the email subject line: «Beta v9.1.6 — [Beta Tester Surname]».

**12.3** The Beta Tester is responsible for keeping their email address up to date and checking their inbox regularly. Communications sent to the email address provided in the Signatures section are considered received.

**12.4 Security notice.** The Owner will never request API Keys, passwords, login credentials, or license files from the Beta Tester via email or any other channel. Any such request should be considered fraudulent and reported immediately.

---

### Article 13 — Voluntary Data Sharing for Certification

**13.1** For TRL5 certification and Software improvement purposes, the Beta Tester is requested to share the following materials:
...
**13.2** Sharing of Input and/or Output Datasets is **entirely voluntary**. The Beta Tester may choose not to share them without any consequence to the validity of this Agreement or access to the Software.

**13.3** A Beta Tester who elects to share Datasets acknowledges that they may contain personal or confidential data and expressly authorizes their processing pursuant to Art. 11, with a maximum retention period of 12 months.

**13.4** The Beta Tester is solely responsible for verifying that any shared Datasets do not contain personal data of third parties for whom the Beta Tester does not hold the necessary processing authorizations.

**13.5 Minimum Dataset requirements for TRL5 certification.** In order to produce data usable for TRL5 certification purposes, the Dataset processed during the beta program must meet the following minimum thresholds:
...
**14.1** The Software is provided in its beta configuration, «as is», **without any warranty, express or implied**.

**14.2** The Owner expressly disclaims any warranty regarding:
...
**14.3** The Beta Tester expressly acknowledges that this is software under development and testing, not intended for production use, and knowingly accepts all associated risks.

---

### Article 15 — Limitation of Liability

**15.1 The Owner shall not be liable, to any extent or under any theory, for any direct, indirect, incidental, special, consequential, or punitive damages** arising from the use of, inability to use, or results of the Software, including without limitation: data loss, loss of profits, business interruption, hardware or software system damage, unexpected API costs, except in cases of willful misconduct or gross negligence by the Owner.
...
**16.1** This Agreement enters into force on the date of signature by both parties and remains valid until expiration of the License (90 days), unless terminated earlier.

**16.2 Termination by the Owner.** The Owner may terminate this Agreement with immediate effect by written notice in the event of:
...
**16.3 Withdrawal by the Beta Tester.** The Beta Tester may withdraw from this Agreement at any time by sending written notice to the Owner.

**16.4 Post-termination obligations.** Upon expiration or termination of this Agreement, the Beta Tester is required to:
...
**16.5 Survival.** The provisions relating to confidentiality (Art. 8), intellectual property (Art. 10), data processing (Art. 11), and limitation of liability (Art. 15) survive the expiration or termination of this Agreement.
...
**17.2** For any dispute relating to the interpretation, performance, or termination of this Agreement, the parties elect as **exclusive competent court the Tribunale Ordinario di Velletri** (Ordinary Court of Velletri).

**17.3** Prior to initiating legal proceedings, the parties undertake to attempt an amicable resolution. The party intending to commence proceedings must first notify the other party in writing, granting a period of **30 (thirty) days** to reach an agreed solution.

---

### Article 18 — General Provisions

**18.1 Entire Agreement.** This Agreement constitutes the entire agreement between the parties with respect to its subject matter and supersedes all prior agreements, understandings, or communications, whether written or oral.

**18.2 Amendments.** Any amendment to this Agreement must be made in writing and signed by both parties. Unilateral amendments have no effect.

**18.3 Severability.** The invalidity, ineffectiveness, or unenforceability of any single provision shall not affect the validity of the remaining provisions, which shall remain in full force and effect.

**18.4 Waiver.** Failure or delay by the Owner to enforce any provision of this Agreement shall not constitute a waiver of the right to enforce it in the future.

**18.5 Assignment.** The Beta Tester may not assign, transfer, or delegate any rights or obligations under this Agreement without the Owner's prior written consent.

**18.6 Notices.** All formal notices required under this Agreement must be made in writing via **PEC (certified email) at a.lattanzi.pec@postecert.it** or by registered mail with acknowledgment of receipt. Communications via ordinary email have no legal value for the purposes of this Agreement.
